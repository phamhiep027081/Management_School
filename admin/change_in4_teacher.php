                                    ...
                                    <table class="card-body ml-5">
                                        <?php
                                            ...
                                            if(isset($_GET['id'])){ 
                                                ...
                                                $sql = "SELECT fullname, birthday, address, phone, khoa_data.Ten_Khoa, khoa_data.Dia_Chi FROM user 
                                                LEFT JOIN khoa_data 
                                        ...
                                        ?>
                                        <form method="POST" action="update_info_teacher.php" class="form-control" autocomplete="off">
                                            <tr>
                                                <!-- <td class="mt-2">Email:</td> -->
                                                <td>
                                                    <input type="hidden" class="form-control ml-3 mt-2" name="email" value="<?php echo $email; ?>">
                                                </td>
                                            </tr>
                                            <tr class="">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="date" class="form-control ml-3 mt-2" name="birth_day" id="" value="<?php echo $info['birthday']; ?>"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control ml-3 mt-2" name="phone" value="<?php echo $info['phone']; ?>"></td>
                                            </tr>
                                            <tr>
